    ...
    <>
        <section className="mt-2 bg-wp mx-auto pt-[8rem] text-white">
            <div className="flex w-full items-center justify-evenly">
                <div className="wow fadeInUp w-[50%]">
        ...
        <section className="bg-[#020202] pt-[1em] pb-[3rem] text-white">
            <div className=" flex w-full items-center justify-evenly">
                <div className="w-[46%]">
                    <h3 className="text-center font-poppins wow bounceInLeft font-[700] pb-[2rem] text-[2rem]">Secure. Simple. All-in-one.</h3>
                    <ul className="wow slideInLeft list-disc">
